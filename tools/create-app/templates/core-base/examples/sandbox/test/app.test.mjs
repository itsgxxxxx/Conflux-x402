...
import { CONFLUX_ESPACE_MAINNET } from '@{{PROJECT_NAME}}/chain-config'
import { createApp } from '../dist/app.js'
import { buildRoutes } from '../dist/routes/config.js'
import { toX402RoutesConfig } from '@{{PROJECT_NAME}}/express-middleware'
...
test('x402 route conversion uses exact scheme with USDT0 asset', () => {
  ...
  const x402Routes = toX402RoutesConfig(routes, config.evmAddress)
